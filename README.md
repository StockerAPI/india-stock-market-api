...
Kun Data provides real-time market data for India through a token-authenticated API stack designed for charting tools, watchlists, market overview pages, brokerage dashboards, and quant workflows.

This repository focuses on India market coverage with support for NSE, BSE.

## API Capabilities

- Real-time WebSocket market data for India
...
This repository is designed to make India market API coverage easier to discover and evaluate.

## Links

- Website: https://kun.pro/markets/india-stock-market-api
